...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  const fetchUser = async () => {
    if (!authUser?.id) {
      console.log("fetchUser: No authUser.id available");
      setUser(undefined);
      return;
    }
    ...
    try {
      setError(null);
      const supabase = createClient();
      console.log("fetchUser: Fetching user data for authUser.id:", authUser.id);
      ...
      console.log("fetchUser: Result:", { fetchedUser, fetchError });
